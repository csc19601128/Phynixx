...
import org.csc.phynixx.loggersystem.messages.ILogRecordListener;
import org.csc.phynixx.loggersystem.messages.ILogRecordSequence;
import org.csc.phynixx.loggersystem.messages.ILogRecordSequenceListener;
 ...
 *         globalen TX beteiligen , um den Transactionsmanager über den
 ...
 *      </td>
              ...
              <tr>
                ...
                <td>XAResource führt abschliessende Arbeiten aus, um das
              ...
              <tr>
                ...
                <td>XAResource führt abschliessende Arbeiten aus, um dass
              ...
              <tr>
                ...
                <td>Da nicht klar ist, ob die XAResource während
                ...
                XAResource dieser übergeben, allerdings im Zustand
                MARK_ROLLBACK. Wenn nein, so wird ein
                <i>abort</i> durchgeführt.</td>
              </tr>
        </table>
