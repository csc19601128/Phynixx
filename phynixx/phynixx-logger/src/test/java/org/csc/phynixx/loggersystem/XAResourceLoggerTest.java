...
import org.csc.phynixx.loggersystem.messages.IDataRecord;
import org.csc.phynixx.loggersystem.messages.IDataRecordSequence;
import org.csc.phynixx.loggersystem.messages.PhynixxXAResourceRecorder;
...
public class XAResourceLoggerTest extends TestCase {
    ...
    public void testXAResourceLogger() throws Exception {
        ...
        PhynixxXAResourceRecorder logger = new PhynixxXAResourceRecorder(loggerFactory.instanciateLogger("test"));
        ...
        try {
            ...
            IDataRecordSequence seq = logger.createMessageSequence();
