 ...
 *
 */
public class SimpleXADataRecorderProvider implements IXARecorderProvider,
         IXADataRecorderLifecycleListener {
   private static final IPhynixxLogger LOG = PhynixxLogManager.getLogger(SimpleXADataRecorderProvider.class);
   ...
   public SimpleXADataRecorderProvider(IDataLoggerFactory dataLoggerFactory) {
   ...
   public boolean equals(Object obj) {
      ...
      if (getClass() != obj.getClass())
         return false;
      final SimpleXADataRecorderProvider other = (SimpleXADataRecorderProvider) obj;
