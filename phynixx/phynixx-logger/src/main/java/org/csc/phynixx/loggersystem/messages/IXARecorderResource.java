 ...
 * @author christoph
 */
public interface IXARecorderResource extends ILogRecordWriter, ILogRecordReader {
    ...
    void logUserData(IDataRecordSequence sequence, byte[][] data) throws InterruptedException, IOException;

    void logUserData(IDataRecordSequence sequence, byte[] data) throws InterruptedException, IOException;

    void preparedXA(IDataRecordSequence sequence);

    void committingXA(IDataRecordSequence sequence, byte[][] data) throws InterruptedException, IOException;

    void startXA(IDataRecordSequence sequence, String resourceId, byte[] xid) throws IOException, InterruptedException;

    void doneXA(IDataRecordSequence sequence);
    ...
    IDataRecordSequence createMessageSequence();
