 ...
 * @author zf4iks2
 */
class LocalTransactionListener<C extends IPhynixxConnection> extends PhynixxManagedConnectionListenerAdapter<C> implements IPhynixxXAConnection, IPhynixxManagedConnectionListener<C> {
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof LocalTransactionListener)) {
            return false;
        }
        return ((LocalTransactionListener) obj).managedConnection.equals(this.managedConnection);
    }
