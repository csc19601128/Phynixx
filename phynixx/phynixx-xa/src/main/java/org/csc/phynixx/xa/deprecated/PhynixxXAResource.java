...
public class PhynixxXAResource<C extends IPhynixxConnection> implements XAResource {
    ...
    private PhynixxXAResourceFactory<C> factory = null;

    /**
     * @supplierCardinality 0..1
     */
    private PhynixxManagedXAConnection<C> currentXAConnectionHandle = null;
    ...
    public PhynixxXAResource(
            ...
            PhynixxXAResourceFactory<C> factory) {
        this.xaId = xaId;
        this.tmMgr = tmMgr;
        this.factory = factory;
        this.currentXAConnectionHandle = new PhynixxManagedXAConnection(this, tmMgr);
    ...
    public void start(Xid xid, int flags) throws XAException {
        try {
            ...
            if (flags == TMRESUME || flags == TMJOIN) {
                ...
                // the current connection is substituted by the connection used by the existing TX
                if (this.currentXAConnectionHandle != null) {
                ...
                if (this.currentXAConnectionHandle != null) {
                    ...
                    handle = new PhynixxManagedXAConnection(this, this.tmMgr);
                }
                ...
                IPhynixxManagedConnection managedConnection = this.factory.getManagedConnectionFactory().getManagedConnection();
                handle.setConnection(managedConnection);
