...
public class TestManagedConnectionStatusListener extends PhynixxManagedConnectionListenerAdapter<ITestConnection> implements IPhynixxManagedConnectionDecorator<ITestConnection> {
