...
/**
 * Baisklasse zur verwaltung von Channelbasoierten Filezugriffen.
 * Es werden RandomAccessFile und der zugehoerigen Channel verwaltet.
 * Es wird die posutionierung innerhalb der Channels verwaltet.
 * 
 * @copyright   Deutsche Post AG
 * @modified    $Date: 2006/11/21 16:08:57 $, $Author: pt6bcc $
 * @author
 * @version     $Revision: 1.2 $
 * @see
 */
public class TAEnabledChannel {
    ...
    /** Gibt das RandomAccseeFile zurueck
     * @return RandomAccseeFile
     */
     ...
     * @throws IOException 
     **/
    TAEnabledChannel (RandomAccessFile  raf) throws IOException {
        this.raf= raf;
 ...
 /**
     ...
     * @exception IllegalArgumentException position ist nicht zuleassig
     *
     **/
    ...
    {
        if( isClose() ) {
            throw new IOException("TAEnabledChannel ist geschlossen");
        }
     ...
     *
     * @author Ivens
     * @return Die Comittete Groesse in Bytes
     * @throws java.io.IOException IO-Fehler
     */
   ...
   /**
     ...
     * @throws java.o.IOException IO-Fehler
     **/
     ...
     * herausgestellt hat, daß die Methode im Batchbetrieb etwas schneller
     * ist als die Channel-methode.
     * Ee werden bytes gelesen fuer die gilt: <br>
     *  startPosition <= b < endPosition
     *
     *
     * @param buffer , der gefuellt werden soll.
     * @param startPosition Position ab der die Daten in den ByteBuffer geschrieben werden sollen
     ...
     public byte[] read(long length) throws IOException
    {
      ...
      * das Limit auf die Kapazität des ByteBuffers (zur weiteren Verwendung)
      *
      * @author Ivens
     ...
     /** Stellt die Comittet Dateigrösse wieder her. Die Comittete Dateigroesse
